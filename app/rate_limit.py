...
limit_monitor_requests = build_rate_limit_dependency(
    bucket="monitor",
    limit_getter=lambda settings: settings.rate_limit_monitor_per_minute,
)

limit_agent_invoke_requests = build_rate_limit_dependency(
    bucket="agent-invoke",
    limit_getter=lambda settings: settings.rate_limit_agent_invoke_per_minute,
)
